...
\begin{theorem}[Fundamental theorem of Riemannian geometry]\label{thm:5.2}
...
\begin{problem}
Verify axioms \autoref{def:5.1.1}--\autoref{def:5.1.6} for the Levi-Civita connection $\nabla$ constructed in the proof of \autoref{thm:5.2}.
\end{problem}
